...
-keep class io.github.abhidroid87.plextube.data.model.** { *; }
-keep class io.github.abhidroid87.plextube.data.local.** { *; }
-keep class io.github.abhidroid87.plextube.data.lyrics.** { *; }
-keep class io.github.abhidroid87.plextube.innertube.models.** { *; }
...
-keep class io.github.abhidroid87.plextube.ui.screens.music.MusicTrack { *; }
-keep class io.github.abhidroid87.plextube.ui.screens.music.MusicArtist { *; }
-keep class io.github.abhidroid87.plextube.ui.screens.music.MusicItemType { *; }
-keep class io.github.abhidroid87.plextube.data.music.Playlist { *; }
-keep class io.github.abhidroid87.plextube.data.music.DownloadedTrack { *; }
-keep class io.github.abhidroid87.plextube.data.music.DownloadStatus { *; }

## Shazam recognition models + kotlinx serializers
-keepclasseswithmembers class io.github.abhidroid87.plextube.data.recognition.shazam.** {
    kotlinx.serialization.KSerializer serializer(...);
}
-keepclassmembers class io.github.abhidroid87.plextube.data.recognition.shazam.** {
    *** Companion;
}
