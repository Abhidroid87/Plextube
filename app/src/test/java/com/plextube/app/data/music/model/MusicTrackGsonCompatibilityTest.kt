...
package com.plextube.app.data.music.model
...
/**
 * MusicTrack moved from com.plextube.app.ui.screens.music to this package. Queues saved by
...
class MusicTrackGsonCompatibilityTest {
    ...
    fun `a round trip through Gson keys on field names not on the class name`() {
        ...
        assertThat(gson.toJson(original)).doesNotContain("com.plextube.app")
    }
