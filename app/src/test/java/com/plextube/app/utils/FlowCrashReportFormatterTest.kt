            ...
            FlowCrashReportSnapshot(
                ...
                stackTrace = """
                    java.lang.OutOfMemoryError: Failed to allocate
                        at com.plextube.app.player.PlayerCacheManager.updateCache(PlayerCacheManager.kt:42)
                        at com.plextube.app.service.VideoPlayerService.onStartCommand(VideoPlayerService.kt:121)
