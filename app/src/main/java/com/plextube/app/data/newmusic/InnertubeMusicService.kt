package com.plextube.app.data.newmusic

import com.plextube.app.data.music.model.ArtistDetails
import com.plextube.app.data.music.model.MusicArtist
import com.plextube.app.data.music.model.MusicCharts
...
import com.plextube.app.innertube.YouTube.SearchFilter
...
import com.plextube.app.innertube.pages.ArtistSectionKind
import com.plextube.app.innertube.pages.ChartsPage
import com.plextube.app.innertube.pages.ExplorePage
import com.plextube.app.innertube.pages.RelatedShelfType
...
object InnertubeMusicService {
    ...
    suspend fun fetchMoodAndGenres(): List<com.plextube.app.innertube.pages.MoodAndGenres> =
        withContext(Dispatchers.IO) {
            try {
        ...
        withContext(Dispatchers.IO) {
            try {
                ...
                result
                    .getOrNull()
                    ?.items
                    ?.filterIsInstance<com.plextube.app.innertube.models.PlaylistItem>()
    ...
    suspend fun fetchArtistItems(
        ...
        withContext(Dispatchers.IO) {
            try {
                val result =
                    YouTube.artistItems(
                        com.plextube.app.innertube.models
                            .BrowseEndpoint(browseId, params),
                    )
                result
                    .getOrNull()
                    ?.items
                    ?.filterIsInstance<com.plextube.app.innertube.models.AlbumItem>()
    ...
    private fun convertAlbumToPlaylist(
        item: com.plextube.app.innertube.models.AlbumItem,
    ...
    private fun convertPlaylistToMusicPlaylist(item: com.plextube.app.innertube.models.PlaylistItem): MusicPlaylist =
        MusicPlaylist(
            id = item.id ?: "",
            title = item.title ?: "",
            thumbnailUrl = item.thumbnail ?: "",
    ...
    private fun convertArtistItemToDetails(item: com.plextube.app.innertube.models.ArtistItem): ArtistDetails =
        ArtistDetails(
            name = item.title ?: "",
            channelId = item.id ?: "",
            thumbnailUrl = item.thumbnail ?: "",
    ...
    suspend fun getMediaInfo(videoId: String): com.plextube.app.innertube.models.MediaInfo? =
        withContext(Dispatchers.IO) {
            try {
