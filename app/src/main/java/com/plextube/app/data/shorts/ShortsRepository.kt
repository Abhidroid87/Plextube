...
import com.plextube.app.data.model.ShortsSequenceResult
...
import com.plextube.app.player.shorts.ShortsStartupTrace
...
class ShortsRepository private constructor(
    ...
    private suspend fun fetchDiscoveryFeed(): ShortsSequenceResult {
        ...
        suspend fun runDiscovery(): List<com.plextube.app.data.model.Video>? =
            try {
        ...
        val discoveryVideos: List<com.plextube.app.data.model.Video> =
     ...
     */
    private fun deduplicateByTitle(videos: List<com.plextube.app.data.model.Video>): List<com.plextube.app.data.model.Video> {
        if (videos.size <= 1) return videos

        val result = mutableListOf<com.plextube.app.data.model.Video>()
        val titleTokens =
            videos.map { video ->
                video to
                    video.title
