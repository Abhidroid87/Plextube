...
import com.plextube.app.ui.components.VideoQuickActionsBottomSheet
...
import com.plextube.app.ui.components.shared.rememberVideoShareAction
import com.plextube.app.ui.components.videoplayer.sheet.FlowLiveChatBottomSheet
import com.plextube.app.ui.components.videoplayer.sheet.FlowPlaylistQueueBottomSheet
...
internal fun PlayerBottomSheetsContainer(
    ...
    LaunchedEffect(Unit) {
        ...
        SleepTimerManager.attachExitCallback {
            ...
            context.stopService(
                android.content.Intent(context, com.plextube.app.service.VideoPlayerService::class.java),
            )
            context.stopService(
                android.content.Intent(context, com.plextube.app.service.Media3MusicService::class.java),
            )
