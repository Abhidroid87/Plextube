...
import com.plextube.app.data.music.DownloadManager as MusicDownloadManager
...
class DownloadsViewModel @Inject constructor(
            ...
            combine(
                ...
                val incomplete = downloads.filter { download ->
                    download.download.videoId !in pending &&
                        download.overallStatus != com.plextube.app.data.local.entity.DownloadItemStatus.COMPLETED
                }
    ...
    fun deleteVideoDownload(videoId: String) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            if (download?.overallStatus != com.plextube.app.data.local.entity.DownloadItemStatus.COMPLETED) {
    ...
    fun removeIncompleteDownloads() {
        viewModelScope.launch(Dispatchers.IO) {
            val ids = videoDownloadManager.allDownloads.first()
                .filter { it.overallStatus != com.plextube.app.data.local.entity.DownloadItemStatus.COMPLETED }
