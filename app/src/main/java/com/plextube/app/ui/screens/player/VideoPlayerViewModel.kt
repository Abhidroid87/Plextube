package com.plextube.app.ui.screens.player
...
import com.plextube.app.data.local.*
import com.plextube.app.data.model.Comment
import com.plextube.app.data.model.Video
import com.plextube.app.data.repository.SponsorBlockRepository
import com.plextube.app.data.repository.YouTubeRepository
import com.plextube.app.data.transcript.TranscriptRepository
import com.plextube.app.data.video.VideoDownloadManager
import com.plextube.app.di.IoDispatcher
import com.plextube.app.di.NetworkIoDispatcher
import com.plextube.app.innertube.pages.VideoCommentSort
...
import com.plextube.app.player.MiniPlayerExpansionState
import com.plextube.app.player.state.EnhancedPlayerState
import com.plextube.app.player.stream.PlaybackLoadResolver
import com.plextube.app.player.stream.PlaybackResolutionRequest
import com.plextube.app.player.stream.UpcomingPremiereProbe
import com.plextube.app.ui.components.FeedInvalidationBus
import com.plextube.app.ui.screens.player.state.*
...
class VideoPlayerViewModel
    ...
    constructor(
        ...
        private val playlistRepository: com.plextube.app.data.local.PlaylistRepository,
        private val playerPreferences: PlayerPreferences,
        private val videoDownloadManager: VideoDownloadManager,
        private val offlineSubtitleStore: com.plextube.app.data.video.OfflineSubtitleStore,
        private val sponsorBlockRepository: SponsorBlockRepository,
        private val liveChatRepository: com.plextube.app.data.repository.LiveChatRepository,
        ...
        notesRepository: com.plextube.app.data.notes.NotesRepository,
        ...
        fun playNext() {
            ...
            if (!handledByPlayer) {
                _uiState.value.relatedVideos.firstOrNull()?.let { nextVideo ->
                    playVideo(nextVideo)
                    com.plextube.app.player.GlobalPlayerState
