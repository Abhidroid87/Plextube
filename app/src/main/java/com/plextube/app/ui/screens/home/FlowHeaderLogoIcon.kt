...
private const val FLOW_LOGO_GLYPH_PATH = "M7.2 17L9.7 7H15.8C17.8 7 18.8 8.1 18.3 9.9C17.9 11.5 16.6 12.4 14.8 12.4H12.8L11.7 17Z"
private const val FLOW_LOGO_COUNTER_PATH = "M13.1 9H15.1C15.8 9 16.2 9.3 16 9.9C15.8 10.5 15.4 10.8 14.7 10.8H12.7Z"
...
internal fun FlowHeaderLogoIcon(
    ...
    val counterPath =
        remember {
            PathParser().parsePathString(FLOW_LOGO_COUNTER_PATH).toPath()
        }
    val incognitoPath =
        remember {
    ...
    Canvas(
        ...
        if (glyphAlpha > 0f) {
            ...
            drawPath(path = counterPath, color = primaryColor.copy(alpha = glyphAlpha))
        }
