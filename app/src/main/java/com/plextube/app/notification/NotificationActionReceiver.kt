...
class NotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_CANCEL_DOWNLOAD = "com.plextube.app.action.CANCEL_DOWNLOAD"
        const val ACTION_RETRY_DOWNLOAD = "com.plextube.app.action.RETRY_DOWNLOAD"
        const val ACTION_PAUSE_DOWNLOAD = "com.plextube.app.action.PAUSE_DOWNLOAD"
        const val ACTION_RESUME_DOWNLOAD = "com.plextube.app.action.RESUME_DOWNLOAD"
        const val ACTION_DISMISS_NOTIFICATION = "com.plextube.app.action.DISMISS_NOTIFICATION"
