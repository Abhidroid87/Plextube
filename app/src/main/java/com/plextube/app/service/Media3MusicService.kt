package com.plextube.app.service
...
import com.plextube.app.data.download.DownloadUtil
import com.plextube.app.data.model.ParametricEQ
...
import com.plextube.app.extensions.setOffloadEnabled
...
import com.plextube.app.player.audio.shouldHandleAudioFocus
import com.plextube.app.player.factory.LoadControlFactory
import com.plextube.app.player.sessionArtworkBitmapLoader
import com.plextube.app.utils.MusicPlayerUtils
import com.plextube.app.utils.NetworkConnectivityObserver
...
class Media3MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var widgetPublisher: com.plextube.app.widget.nowplaying.NowPlayingWidgetPublisher
    ...
    override fun onCreate() {
        ...
        lifecycleScope.launch {
            com.plextube.app.player.EnhancedMusicPlayerManager.isLiked.collectLatest {
                updateNotification()
        ...
        lifecycleScope.launch {
            var lastQuality: com.plextube.app.data.local.MusicAudioQuality? = null
    ...
    private fun applyMusicQualityChange() {
        ...
        try {
            ...
            com.plextube.app.player.EnhancedMusicPlayerManager
                .clearUrlCache()
        } catch (e: Exception) {
    ...
    private fun resolveLearnTrack(mediaId: String?): MusicTrack? {
        ...
        val manager = com.plextube.app.player.EnhancedMusicPlayerManager
    ...
    private fun initializeSession() {
        val intent =
            Intent(this, MainActivity::class.java).apply {
                action = "com.plextube.app.action.OPEN_MUSIC_PLAYER"
    ...
    private fun updateNotification() {
        ...
        val isLiked = com.plextube.app.player.EnhancedMusicPlayerManager.isLiked.value
        ...
        override fun onGetChildren(
            ...
            val items =
                when (parentId) {
                    ...
                    AUTO_QUEUE_ID -> {
                        com.plextube.app.player.EnhancedMusicPlayerManager.queue.value
                            .map { it.toAutoMediaItem() }
                    }

                    AUTO_CURRENT_ID -> {
                        com.plextube.app.player.EnhancedMusicPlayerManager.currentTrack.value
