package com.plextube.app.player.media
...
import com.plextube.app.player.renderer.subtitle.Srv3SubtitleParser
import com.plextube.app.player.resolver.VideoPlaybackResolver
import com.plextube.app.player.sabr.integration.SabrMediaSourceFactory
import com.plextube.app.player.sabr.integration.SabrMediaSourceResult
import com.plextube.app.player.sabr.integration.SabrOrchestrator
...
class MediaLoader(
    ...
    fun loadMedia(
        ...
        innerTubeVideoFormats: List<com.plextube.app.innertube.models.response.PlayerResponse.StreamingData.Format> = emptyList(),
        innerTubeAudioFormats: List<com.plextube.app.innertube.models.response.PlayerResponse.StreamingData.Format> = emptyList(),
        mediaId: String = "",
