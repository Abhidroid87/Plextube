...
import com.plextube.app.data.local.AudioSettingsPersistence
import com.plextube.app.data.local.QueuePersistence
...
object EnhancedMusicPlayerManager {
    ...
    suspend fun resolveStreamUrl(videoId: String): String? {
        ...
        return try {
            val playbackData =
                com.plextube.app.utils.MusicPlayerUtils
        ...
        controller.addListener(
            object : Player.Listener {
                ...
                override fun onPlayerError(error: androidx.media3.common.PlaybackException) {
                    ...
                    showPlaybackWarning(
                        appContext?.getString(com.plextube.app.R.string.music_playback_warning_generic)
    ...
    private fun applyEqProfile(profile: com.plextube.app.data.model.ParametricEQ) {
        try {
            val json =
                Json.encodeToString(
                    com.plextube.app.data.model.ParametricEQ
                        .serializer(),
                    profile,
                )
            val bundle =
