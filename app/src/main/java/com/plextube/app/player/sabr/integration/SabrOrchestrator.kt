package com.plextube.app.player.sabr.integration

import android.util.Log
import com.plextube.app.player.sabr.core.SabrEvent
import com.plextube.app.player.sabr.core.SabrStreamController
...
class SabrOrchestrator(
            ...
            scope?.async(Dispatchers.IO) {
                val fresh =
                    try {
                        ...
                        com.plextube.app.player.error.PlayerDiagnostics
    ...
    private fun bufferedAheadMs(state: com.plextube.app.player.sabr.core.SabrSessionState): Long {
        val audioEndMs =
    ...
    private fun targetReadaheadMs(state: com.plextube.app.player.sabr.core.SabrSessionState): Long =
