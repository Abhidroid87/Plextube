package com.plextube.app.player.sabr.core

import android.util.Log
import com.plextube.app.player.sabr.network.SabrDataSource
import com.plextube.app.player.sabr.proto.FormatBufferedRange
import com.plextube.app.player.sabr.proto.FormatId
import com.plextube.app.player.sabr.proto.FormatInitializationMetadata
import com.plextube.app.player.sabr.proto.MediaHeader
import com.plextube.app.player.sabr.proto.NextRequestPolicy
import com.plextube.app.player.sabr.proto.PlaybackStartPolicy
import com.plextube.app.player.sabr.proto.SabrContextUpdate
import com.plextube.app.player.sabr.proto.SabrContextSendingPolicy
import com.plextube.app.player.sabr.proto.SabrError
import com.plextube.app.player.sabr.proto.SabrRedirect
import com.plextube.app.player.sabr.proto.SabrSeek
import com.plextube.app.player.sabr.proto.StreamProtectionStatus
import com.plextube.app.player.sabr.ump.UmpFrame
import com.plextube.app.player.sabr.ump.UmpFrameDecoder
import com.plextube.app.player.sabr.ump.UmpPartType
import com.plextube.app.player.sabr.ump.SabrMediaPayload
...
class SabrStreamController(
    ...
    private suspend fun trackMedialessResponses() {
        ...
        if (consecutiveMedialessResponses >= MAX_MEDIALESS_RESPONSES) {
            ...
            com.plextube.app.player.error.PlayerDiagnostics.logError(
    ...
    private suspend fun handleReloadRequired(frame: UmpFrame) {
        ...
        val token = try {
            var t: String? = null
            com.plextube.app.player.sabr.proto.ProtobufReader(frame.payload).forEachField { field ->
                if (field.fieldNumber == 1) {
                    com.plextube.app.player.sabr.proto.ProtobufReader(field.asBytes()).forEachField { inner ->
        ...
        com.plextube.app.player.error.PlayerDiagnostics.logWarning(
