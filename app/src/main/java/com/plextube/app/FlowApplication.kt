...
import com.plextube.app.data.local.CONTENT_LANGUAGE_FOLLOW_APP
import com.plextube.app.data.local.PlayerPreferences
import com.plextube.app.data.local.SubscriptionRepository
import com.plextube.app.data.repository.NewPipeDownloader
...
import com.plextube.app.innertube.models.normalizeYouTubeHostLanguage
import com.plextube.app.innertube.pages.NewPipeExtractor
import com.plextube.app.network.AppProxyManager
import com.plextube.app.notification.NotificationHelper
import com.plextube.app.notification.SubscriptionCheckWorker
...
import com.plextube.app.utils.cipher.PipePipeNsigDecoder
import com.plextube.app.utils.newPipeContentCountry
import com.plextube.app.utils.newPipeLocalization
import com.plextube.app.utils.normalizeYouTubeCountry
import com.plextube.app.utils.potoken.NewPipePoTokenProvider
...
class FlowApplication :
    ...
    @Inject
    lateinit var channelReelIndex: com.plextube.app.data.shorts.ChannelReelIndex
    ...
    override fun onCreate() {
        ...
        CoroutineScope(SupervisorJob() + Dispatchers.IO).launch {
            ...
            if (BuildConfig.UPDATER_ENABLED) {
                com.plextube.app.notification.UpdateCheckWorker
        ...
        CoroutineScope(SupervisorJob() + Dispatchers.IO).launch {
            ...
            try {
                com.plextube.app.utils.potoken.WebPoTokenSession
                    .prewarm()
            } catch (e: Exception) {
    ...
    private fun applyProxyConfig(config: com.plextube.app.network.AppProxyConfig) {
