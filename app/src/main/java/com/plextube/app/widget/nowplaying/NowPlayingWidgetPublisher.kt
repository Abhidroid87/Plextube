...
import com.plextube.app.widget.core.markNowPlayingStopped
import com.plextube.app.widget.core.writeNowPlayingSnapshot
...
class NowPlayingWidgetPublisher @Inject constructor(
    ...
    private suspend fun updatePlayerWidgets() {
        ...
        com.plextube.app.widget.turntable.TurntableWidget().updateAll(context)
    }
}
